...
app.controller('contactCtrl', function ($scope, $http) {
    ...
    $scope.urlContactAPI = "http://jsonplaceholder.typicode.com/users";// API for test, it doesn't access a Data Base.
    ...
    $scope.saveContact = function () {
        ...
        if (dataContact.id == null) {
            ...
            $http.post($scope.urlContactAPI + "/?id=" + $scope.contact.id, $.param({ dataContact })).then(function (resp) {
    ...
    $scope.deleteContact = function () {        
        ...
        function () {
            $http.delete($scope.urlContactAPI + "/?id=" + $scope.contact.id).then(function (resp) {                
                // put here code for success               
                
            }, function (response) {               
                // put here code for handle error
                // $('#modalContact').modal('toggle');
                //return;
